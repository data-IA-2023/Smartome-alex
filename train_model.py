...
if __name__=='__main__':
    ...
    est=train_temp_prediction_model(df_X,df_y,span=span,model_type='rand_forest')
    ...
    y_fc=predict_heat_time(est,X_fc,"2024-04-06",start_target_temp=7,target_temp=22,span=span,tol=2)
